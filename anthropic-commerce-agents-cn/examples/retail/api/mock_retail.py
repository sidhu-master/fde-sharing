...
_SEARCH_ALIASES = {
    # Keep the original English demo query useful after the Retail catalog is localized.
    "AR-1002": "coffee maker espresso machine",
    "AR-1207": "ACME Journey 55L Hiking Backpack",
    "AR-1508": "ACME Paws 10-Gallon Aquarium Starter Kit",
    "AR-1606": "ACME Rest Mulberry Silk Pillowcase",
    "AR-1903": "ACME Sleep Washed-Cotton Duvet Set Queen",
    "AR-2102": "ACME Kids Peel-and-Stick Ocean Wall Decals 36 pc",
    "AR-2106": "ACME Kids Toy Storage Bins Set of 3",
    "AR-1401": "stacking wooden block set 54 pieces",
}
...
class MockRetail(StorefrontBackend):
    ...
    def _searchable_text(self, product: ProductDetails) -> dict[str, str]:
        return {
            "title": f"{product.title} {_SEARCH_ALIASES.get(product.product_id, '')}",
